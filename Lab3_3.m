% Example for PSD Estimation Using Blackman-Tukey Method
%
clc
clearvars
close all
...
line(w/pi,10*log10(Pxx),'Parent',axes1,'LineWidth',1.5,'Color',[0 0 1]); 
